...
const root=resolve(import.meta.dirname,'..'),base=resolve(root,'.artifacts/batch27'),work=resolve(root,'.artifacts/batch28'),out=resolve(work,'deploy/pages-dist')
...
assert.equal(current.deploymentId,'afa161e6-2f2b-4459-9fef-878e87534efc')
...
const changed=new Set(['app/src/heading_catalog_supplement.ts','app/src/screens/search.ts','app/src/central_heading_bootstrap.ts','app/src/engine/search_store.ts','app/src/heading_dictionary_release.ts','app/src/main.ts','app/src/search_unavailable_ui.ts','app/src/search_index_repair_runtime.ts','app/src/engine/heading_index.ts','app/src/background_search_index.ts','app/src/pdf_heading_index.ts','app/src/heading_range_batch.ts'])
...
const stage={passed:true,published:false,version:'batch-20260916-28',baselineDeploymentId:current.deploymentId,payloadFingerprint:payload.fingerprint,deployFingerprint:final.fingerprint,functionsFingerprint,changed:[...changed],files:final.fileCount,productionMigrations:[]}
