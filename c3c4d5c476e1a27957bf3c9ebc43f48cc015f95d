...
assert.equal(current.deploymentId,'c106b186-a84c-42dd-92bb-f42d6f20469b')
...
execFileSync(process.execPath,['tools/build-heading-book-ranges.mjs'],{cwd:root,stdio:'inherit'})
const changed=new Set(['app/src/central_heading_search.ts','app/src/central_heading_bootstrap.ts','app/src/heading_catalog_supplement.ts','app/src/heading_book_ranges.ts','app/src/heading_book_ranges.generated.json','app/src/published_grid_selection.ts'])
...
const stage={passed:true,published:false,version:'batch-20260916-29',baselineDeploymentId:current.deploymentId,payloadFingerprint:payload.fingerprint,deployFingerprint:final.fingerprint,functionsFingerprint,changed:[...changed],files:final.fileCount,productionMigrations:[]}
