...
stage.changed=[...new Set([...stage.changed,'app/src/engine/search_store.ts'])];stage.payloadFingerprint=payload.fingerprint;stage.deployFingerprint=final.fingerprint;stage.files=final.fileCount
