...
test('collects static screen dependencies only and handles cycles',()=>{
 const bundle={a:{type:'chunk',name:'home',isDynamicEntry:true,fileName:'a',imports:['b','main'],dynamicImports:['pdf']},b:{type:'chunk',imports:['a']},main:{type:'chunk',isEntry:true,imports:[]},pdf:{type:'chunk',imports:[]}}
