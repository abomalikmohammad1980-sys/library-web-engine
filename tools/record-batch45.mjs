...
const batch=process.argv[4]??'45';assert(['45','48','53','54','55'].includes(batch))
...
if(['53','54','55'].includes(batch))await writeFile(`docs/design-audit/BATCH${batch}_DEPLOYMENT_20260918.json`,JSON.stringify(receipt,null,2),{flag:'wx'})
