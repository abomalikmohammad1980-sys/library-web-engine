...
assert(['56','57','58','59','60'].includes(batch))
...
const fonts = JSON.parse(await readFile('.artifacts/performance-20260918/client-pass'+(batch==='60'?'5':batch==='59'?'4':'3')+'/font-cache-map.json'))
