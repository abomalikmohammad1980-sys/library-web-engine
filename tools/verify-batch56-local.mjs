...
assert(['56','57','58','59','60','61','62','63','64','65','66','67','68','69','70','71','72','73','74'].includes(batch))
...
const fonts = JSON.parse(await readFile(['64','65','66','67','68','69','70','71','72','73','74'].includes(batch)?'.artifacts/performance-20260920/client-pass'+({'64':'8','65':'9','66':'11','67':'11','68':'12','69':'12','70':'13','71':'14','72':'15','73':'16','74':'17'}[batch])+'/font-cache-map.json':'.artifacts/performance-20260918/client-pass'+(['61','62','63'].includes(batch)?'6':batch==='60'?'5':batch==='59'?'4':'3')+'/font-cache-map.json'))
