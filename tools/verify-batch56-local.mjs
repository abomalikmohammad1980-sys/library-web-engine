...
assert(['56','57','58','59','60','61','62','63','64','65'].includes(batch))
...
const fonts = JSON.parse(await readFile(['64','65'].includes(batch)?'.artifacts/performance-20260920/client-pass'+(batch==='65'?'9':'8')+'/font-cache-map.json':'.artifacts/performance-20260918/client-pass'+(['61','62','63'].includes(batch)?'6':batch==='60'?'5':batch==='59'?'4':'3')+'/font-cache-map.json'))
