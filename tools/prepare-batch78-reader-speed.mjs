...
const root=resolve(import.meta.dirname,'..'),base=resolve(root,'.artifacts/batch77'),out=resolve(root,'.artifacts/batch78'),app=resolve(root,'.artifacts/reader-speed-20260921/client')
...
replacements.set('sw.js',Buffer.from(stampServiceWorkerRelease(sw.replace("const CACHE = 'alkhizana-shell-v18'","const CACHE = 'alkhizana-shell-reader78'"),optimized.index)))
