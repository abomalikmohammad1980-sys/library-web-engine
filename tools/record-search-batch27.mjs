...
const root=resolve(import.meta.dirname,'..'),work=resolve(root,'.artifacts/batch27'),ops=resolve(root,'alpha-publish/ops')
...
const receipt={...stage,published:true,deploymentId:deployed.id,url:deployed.url,productionUrl:'https://khzanah.com',publishedDirectory:'../.artifacts/batch27/deploy/pages-dist',functionsSnapshot:'../.artifacts/batch27/deploy/functions',sourceSnapshot:'../.artifacts/batch27/source-snapshot.json',previousDeploymentId:previous.deploymentId,rollbackDirectory:previous.publishedDirectory,rollbackFunctionsSnapshot:'../.artifacts/batch26/deploy/functions',primaryAssetVerification:'../.artifacts/batch27/production-http.json',publishedAt:new Date().toISOString(),fullAcceptanceClosed:false,caveats:['Cold sub-second search target remains open.','A legacy normalizer source-hash test still fails, documented before this repair.']}
